"""
Django settings for gprojetogerenciamentoativos project.
...
ROOT_URLCONF = 'projetogerenciamentoativos.urls'
...
WSGI_APPLICATION = 'projetogerenciamentoativos.wsgi.application'
